...
* **Software Intern @ UNIFEI & Vale | Projeto VR-Mining 789D**
  Atuo no desenvolvimento de um simulador de baixo custo para treinamento de operadores de mineração, com foco em computação gráfica e engenharia de software para criar ambientes de simulação realistas e eficientes.
...
* **Skills:** Extração de features, conversão de coordenadas espaciais e modelagem de mapas topológicos.
